class Restaurant:
    ...
    def admin_register(self):
        try:
            ...
            print("\n!!CONGRATULATIONS ADMIN!! YOUR ACCOUNT HAS BEEN CREATED SUCCESSFULLY!!\n")
            print(f"WELCOME TO {self.restro_name} ReESTRAUNT\nWE ARE DELIGHTED TO HAVE YOU")
            print("ADMIN DETAILS: ")
    ...
    def admin_login(self):
        try:
            print(f"WELCOME TO {self.restro_name} RESTRAUNT\n\n")
            ...
            if len(self.admin_details.values())!=0:
                if email==self.admin_email and pas==self.admin_pass:
                    ...
                    while True:
                        print("\nCHOOSE ONE AMONGST FOLLOWING OPTIONS\n")
    ...
    def add_food_item(self):
        try:
            ...
            quantity=float(input("ENTER THE QUANTITY OF FOOD ITEM IN VALUES ONLY: "))
            price=float(input("ENTER THE PRICE OF FOOD ITEM: "))
            discount=float(input("ENTER THE DISCOUNT ON FOOD ITEM: "))
            stock=float(input("ENTER THE AMOUNT OF STOCK AVAILABLE: "))
            food_item={"Name":name,"Quantity":quantity,"Price":price,"Discount":discount,"Stock":stock}
            self.food_ID=len(self.food)+1
            self.food[self.food_ID]=food_item
            print("\n!!CONGRATULATIONS!! Food Item added successfully !!\n")
    ...
    def view_food_item(self):
        ...
        if len(self.food)!=0:    
            ...
            print("!! SORRY OUR FOOD CART IS EMPTY AT THE MOMENT !!\n")
...
try:
    def main():
        obj=Restaurant("RISHIKAs")
        print(f"!!######______Welcome To {obj.restro_name} Restaurant______###### !!\n")
        print("\n\n!!WE ARE DELIGHTED TO HAVE YOU!!")
        print("\nWE HOPE YOU WILL HAVE A FANTASTIC EXPERIENCE!!!!\n")
...
print("THANK YOU!! \n\nWE HOPE YOY HAD A WONDERFUL EXPERIENCE!!\n\nPLEASE VISIT AGAIN!!")